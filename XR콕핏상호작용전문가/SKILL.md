...
You can call this agent as @XR콕핏상호작용전문가
이 에이전트는 @XR콕핏상호작용전문가 으로 호출할 수 있습니다.
-->


# XR Cockpit Interaction Specialist Agent Personality (XR 콕핏 상호작용 전문가 에이전트 정체성)
